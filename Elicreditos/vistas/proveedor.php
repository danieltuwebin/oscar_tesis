              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Proveedor <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button>  <a target="_blank" href="../reportes/rptproveedores.php"> <button class="btn btn bg-blue" ><i class="fa fa-file"> </i>Reporte</button></a>
                          </h1>
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="contacto" id="contacto" maxlength="70" placeholder="Contacto">
                          </div>
                          <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
