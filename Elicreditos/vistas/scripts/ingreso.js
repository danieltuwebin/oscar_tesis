...
function limpiar()
{
    ...
    //Obtenemos la fecha actual emision
    var now = new Date();
...
function mostrar(idingreso)
{
    $.post("../ajax/ingreso.php?op=mostrar",{idingreso : idingreso}, function(data,status)
    {
        ...
        $("#idproveedor").selectpicker('refresh');
        $("#condicioni").val(data.condicioni);
        $("#condicioni").selectpicker('refresh');
...
function agregarDetalle(idarticulo,articulo)
  {
    ...
    if (idarticulo!="")
    {
        ...
        '<td><input type="decimal-number" name="precio_compra[]" id="precio_compra[]" value="'+precio_compra+'"></td>'+
        '<td><input type="decimal-number" name="precio_venta[]" value="'+precio_venta+'"></td>'+
